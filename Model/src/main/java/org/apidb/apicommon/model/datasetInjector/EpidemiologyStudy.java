...
public abstract class EpidemiologyStudy extends DatasetInjector {
  ...
  public void addModelReferences() {
	  ...
	  addWdkReference(sampleRecordClass, "table", "HouseholdsDownload", new String[]{"download"}, CATEGORY_IRI,0);
